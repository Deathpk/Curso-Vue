		...
		<div class="conteudo">
			<form class="painel" v-if="!enviado">
				...
				<Rotulo nome="Prioridade">
					<select v-model="prioridadeAtual">
			...
			<div class="painel" v-else>
				...
				<Rotulo nome="Idade">
					<span type="password">{{usuario.idade}} {{tipoIdade}}</span>
				</Rotulo>
...
export default {
	...
	computed:{
		...
		showPrioridadeName() {
			const findNameByCod = (prioridade)=> prioridade.codigo === this.prioridadeAtual
			return this.prioridades.filter(findNameByCod)[0].nome
		}
	},
	methods: {
		enviar(){
